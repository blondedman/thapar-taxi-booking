      ...
      <FlatList
        ...
        ListHeaderComponent={
          <>
            ...
            <Link href="../find-ride" className="text-lg text-center text-general-200 mt-2">
              <Text className="text-primary-500">(find your preferred ride)</Text>
            </Link>

            <>
              <Text className="mx-3 text-xl font-JakartaBold mt-2 mb-3">Your Current Location</Text>
